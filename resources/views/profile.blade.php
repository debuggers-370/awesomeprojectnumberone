            ...
            <div class="w3-col m3">
                ...
                <div class="w3-card-2 w3-round w3-white">
                    <div class="w3-container">
                        ...
                        <hr>
                        <p>
                            <a href="profileEdit.html"><i class= "fa-fw w3-margin-right w3-text-theme"></i>Edit
                                profile </a></p>
          ...
          <i class="fa fa-remove"></i>
            ...
            <div class="w3-col m7">
                ...
                <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
                    ...
                    <button type="button" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-check"></i> Â accept</button>
                    <button type="button" class="w3-button w3-theme-d2 w3-margin-bottom"><i class="fa fa-remove"></i> Â reject</button>
                </div>
